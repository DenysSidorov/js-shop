    ...
    <div className='userWaysContainer'>
      <div className='userWays'>
        ...
        <div className='userDataForOrder'>
          ...
          <input value={state.name} onChange={chName} ref={nameV} type='text' className='shopInput' id='nameInput' />
          <p>
          ...
          <input value={state.email} onChange={chEmail} ref={emailV} type='text' className='shopInput' id='mailInput' />
        </div>
