    ...
    render() {
        return (
            <div className="exchangeContainer">
                ...
                <div>
                    <p className="exchangeContainer__desc">Мы сделаем все возможное, что бы решить вашу проблему, которая возникла с любым из наших товаров. Перейдя на "американский" метод обслуживания клиентов, мы даем вам больше гарантий, чем закон о защите прав потребителя. При этом, бюрократические моменты сведены к минимуму.</p>
