      ...
      <>
          ...
          <div className='container'>
            ...
            <div className='howWeMake_blocks'>
              ...
              <div className='howWeMake_blocks_item'>
                ...
                />
                <div className='howWeMake_blocks_item_desc'>
                  Хотите удивить своих клиентов и сотрудников яркими и со вкусом подобранными изображениями, тогда мы
                  вам поможем.
                </div>
              </div>
            </div>
        ...
        <div className='examplesContBody'>
          <div className='examplesContBodyText'>
            ...
            <div className='examplesContBodyTextContent'>
              Один из главнейших этапов - это упаковка, несколько слоев защиты и верхний презентабельный вид, делают
        ...
        <div className='yourPhoto'>
          <div className='container'>
            ...
            <div className='yourPhoto_description'>
              Вы можете заказать картины со своим изображением, просто отправьте его нам, мы обработаем его и вы
              получите результат.
            </div>
        ...
        >
          <div className='buyNowBlock_container'>
            ...
            результат и качество превыше всего.
          </div>
        </div>
