...
export const AUTH_USER_SAGA_REQUESTED: string = `${identificator}/AUTH_USER_SAGA_REQUESTED`;
export const UNAUTH_USER_SAGA_REQUESTED: string = `${identificator}/UNAUTH_USER_SAGA_REQUESTED`;
export const APPEAR_LIKE_ADMIN_SAGA_REQUESTED: string = `${identificator}/APPEAR_LIKE_ADMIN_SAGA_REQUESTED`;
