...
export const DECREMENT_ITEM_IN_CART: string = `${identificator}/DECREMENT_ITEM_IN_CART`;
export const DELETE_ALL_ITEM_IN_CART: string = `${identificator}/DELETE_ALL_ITEM_IN_CART`;
